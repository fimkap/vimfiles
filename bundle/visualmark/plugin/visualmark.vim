...
"if &bg == "dark"
" highlight SignColor ctermfg=white ctermbg=blue guifg=black guibg=Wheat
"else
" highlight SignColor ctermbg=white ctermfg=blue guibg=black guifg=Wheat
"endif
...
"  call Dfunc("Vm_place_sign()")
  ...
  exe 'sign define SignSymbol text=>> texthl=Search'
